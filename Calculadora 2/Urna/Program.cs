...
namespace Calculadora
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Clear();
            Console.WriteLine("**************************************");
            Console.WriteLine("Bem Vindo à Calculadora Simples meu mano!!!");
            Console.WriteLine("**************************************");
            ...
            while (continuar.ToLower() == "sim")
            {
                ...
                if (!erro)
                    Console.WriteLine($"\nO resultado do baragujohnson é: {resul}");
            ...
            Console.WriteLine("**************************************");
            Console.WriteLine("Resumo de tudo:");
            Console.WriteLine("---------------------------------------");
            Console.WriteLine($"Operações válidas: {operacaoVal}");
            Console.WriteLine($"Erros encontrados: {operacaoErro}");
            Console.WriteLine("Thank you so much boy or girl por usar a minha calculadora (-_°)");
            Console.WriteLine("**************************************");
